...
export const CardSwiper = ({ city }: { city: ICity }) => {
  return (
    <Swiper pagination={true} modules={[Pagination]} className="layout-swiper">
      {city.photos.map((photo: string) => (
      ...
      <h3 className="absolute left-4 bottom-4 z-10 capitalize text-white">
